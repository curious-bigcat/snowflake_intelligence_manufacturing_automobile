...
```
Creates a unified semantic view (`manufacturing_operations`) for all structured/semi-structured data and a unified Cortex Search service (`manufacturing_documents_search`) for all unstructured data.
...
- `02_create_semantic_views.sql` - Unified semantic view (`manufacturing_operations`) for all structured/semi-structured data
- `02a_create_cortex_search.sql` - Unified Cortex Search service (`manufacturing_documents_search`) for all unstructured data
- `03_create_agents.sql` - Intelligence agents with FROM SPECIFICATION syntax, tools, and tool_resources
